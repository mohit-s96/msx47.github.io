...
class Main extends Component {
    componentDidMount(){
        ...
        setTimeout(() => {
            document.getElementById('navbar-wrapper').classList.add('navbar-wrapper-animate');
            document.getElementById('hero-main-grid').classList.add('hero-main-grid-animation');
            ...
            <div className="parent-wrapper">
                ...
                <Navbar/>
                {
                    ...
                    <div className="hamburger-wrapper">
                        <img src={hmb} width="35" alt="hamburger" onClick={this.showNavbar}/>
                    </div>
                    :
                    null
                }
                ...
                <About/>
                <Projects/>
                <div className="overlay" id="overlay" onClick={this.closeOverlay}><ProjectModal/></div>
                <ContactFooter/>
                </div>
            </div>
        )
